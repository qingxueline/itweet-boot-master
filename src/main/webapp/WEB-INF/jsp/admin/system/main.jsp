...
<div class="leftnav">
	...
	<ul>
		<li><a href="<%=basePath%>admin/course/add" target="right"><span class="icon-caret-right"></span>教程发布</a></li>
		<li><a href="<%=basePath%>admin/course/list" target="right"><span class="icon-caret-right"></span>教程列表</a></li>
	</ul>
