...
<div id="content">
	...
	<div class="team-text">
		...
		<h5 style="font-family: STXingkai">你可以通过社交网络与我们取得联系，互相学习!</h5>
	</div>
	<div class="spacer"></div>
	<div class="about">
		<h5 style="font-family: STXingkai">关于自由软件设计.</h5>
		<p>
			游走在极客路上的小码农，一枚热爱Coding的攻城狮，设计了一些自由的软件，初衷是设计给自己用，做为一个有品位的人，
			很难找到和我意的自由软件，而我设计的软件朋友看到都很是喜欢，所以开源出来：<br>
